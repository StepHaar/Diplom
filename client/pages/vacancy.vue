<template id="vacancy_page">
    <base-page-title :title="data?.banner.title" 
    :subtitle="data?.banner.subtitle" 
    :img="data?.banner.img"
    class="vacancy_photo"/>
    <vacancy-Vacancycards :data="data?.cards"/>
</template>
...
export default {
    ...
    mounted() {
        axios.get("http://stud.shubizle11.beget.tech/v1/methods/vacancy_request")
            .then(response => {
...
<style>
.vacancy_photo .image-wrapper img{
