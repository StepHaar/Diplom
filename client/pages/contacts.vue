<template>
    <base-page-title 
        ...
        :img="data?.banner.img"
        class="contacts_photo"/>
    <contacts-info :data="data?.info"/>
...
export default {
    ...
    mounted() {
        axios.get("http://stud.shubizle11.beget.tech/v1/methods/contacts_request")
            .then(response => {
...
<style>
.contacts_photo .image-wrapper img{
    border-radius: 20px 20px 0 0 !important;
}

@media screen and (max-width: 1200px){
    .contacts_photo .page-title__text-title{
        margin-bottom: 80px;
    }
}
</style>